...
export const routeContracts = [
  ...
  route('GET', '/api/v1/ops/outbox', 'GLOBAL', 'NOT_APPLICABLE', 'CURSOR'),
  route('GET', '/api/v1/ops/outbox/summary', 'GLOBAL', 'NOT_APPLICABLE', 'BOUNDED_FILTER'),
  route('POST', '/api/v1/ops/outbox/{id}/requeue', 'GLOBAL'),
