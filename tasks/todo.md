...
- [ ] **SEC-02** RLS real por rol/cuadrilla/operación. Matriz OQ-01/OQ-02 resuelta en [ADR 0009](../docs/decisions/0009-rbac-and-production-topology.md); migración `0014_rbac_scope_policy.sql` y pruebas reales de coordinador pendientes de ejecutarse en la base del CI.
