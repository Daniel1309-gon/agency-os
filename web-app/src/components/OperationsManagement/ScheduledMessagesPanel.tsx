      ...
      {!isLoading && <div className="management-schedule__grid">
        <form className="panel management-form" onSubmit={(event) => void createMessage(event)}>
          ...
          <div className="management-form__grid">
            ...
            <label><span>Envío (hora de Bogotá)</span><input required type="datetime-local" value={form.scheduledFor} onChange={(event) => updateField('scheduledFor', event.target.value)} /></label>
